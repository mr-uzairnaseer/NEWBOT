...
def main():
    ...
    print("=== Writing updated extensions.conf to handle chan_sip and 77777 ===")
...
; We pass the Asterisk UNIQUEID as the call identifier
...
same => n,AGI(/opt/voicebot/agi_check.py,${UNIQUEID})
